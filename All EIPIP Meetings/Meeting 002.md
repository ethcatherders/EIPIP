...
**Speaker 6**
Do you have a particualr conference in mind with that?
...
**Brent Allsop**
Just brainstorming and idea for how to do that kind of stuff - at Canonizer, we have what's called a peer ranking expert system, where peers can rank each other. And so that gives you a quantitative measure of their rank in the community, and we could set something like that up where everyone could vote for people. And then the peers could rank each other and then you get a quantitative score. And if you meet a certain bar, then you can become an editor. Just an idea.

**Speaker 9**
Ranking people for the technical things is not something I'm very comfortable with, but I want to have more funding to pay for more tests. I'm sure we could find people they were meeting were paid even a lot of money, but just something to contribute for their effort.

**Speaker 9**
I think we probably finding other people I'm paid if we had a clearness of criteria of what they want.

**Time Beiko**
I'm a bit conscious of adding a tool or a dependency in this process. I feel like it has to be kind of half explicit criteria, half rough consensus, probably from the current EIP editors. But I think we probably definitely need more people.

**James**
So when I was talking with Alex earlier, one of the EIP editors, they they spent some time trying to find more, find other ones previously. One of his feedbacks was it was hard to find people really are active. To say it another way, what we don't wanna have happen is a system that finds the best EIP but tehn never fills up. Being qualified, wanting to do it, and also doing it are three sides of a Venn diagram.

**Time Beiko**
People can probably do this without getting aid are people who work on consensus or EF or someplace like that for another company where it's their job gets them to work on Ethereum full time and this is just part of their open source work they do. And then the challenge is also is it the best use of of that person's time? Like, what's the Venn diagram of, like, the person could be writing code to contribute to Ethereum or writing EIPs and other people who are just like technical technical enough to do the EIPS part, and it's maybe not like that big of an opportunity costs for them to actually be doing this work.

**James**
Two different conversations - one is what is the bar for? becoming an EIP editor, the other one being how do we get people tha fulfill and start working on it.
